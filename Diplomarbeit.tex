...
\begin{document}
	...
	\input{textparts/titel}									%Externe .tex Datei für Titel einbinden
...
%-----------------------------------------------------------------
	...
	\input{textparts/erklaerung}				%Externe .tex Datei für Erklärung einfügen
	\cleardoublepage									%Neue Seite beginnen
	\phantomsection
...
\clearpage
\input{textparts/uebersicht.tex}
\clearpage
\input{textparts/grundlagen.tex}
\clearpage
\input{textparts/optimierung.tex}
\clearpage
\input{textparts/gpu.tex}
\clearpage
\input{textparts/wavefront.tex}
\clearpage
\input{textparts/sota.tex}
\clearpage
...
%--------------------------------------------------------------------------
  ...
  \phantomsection
	...
	\begin{thebibliography}{999}
		\bibitem[Re:Book02]{kopka1:00} 
		Helmut Kopka:
		  \emph{Latex Band 1, Einführung} \\ 
		  Addison-Wesley, 2000  \\
		  ISBN: 3-8273-7038-8
		\bibitem[Re:Book02]{demig:04}
		  Demmig, Thomas: \\
			\emph{jetzt lerne ich Latex 2} \\
			Markt+Technik, 2004 \\
			ISBN 3-8272-6517-7
		\bibitem[Re:Web01]{Web:01}
		\href{http://www.meta-x.de/faq/LaTeX-Einfuehrung.html}{http://www.meta-x.de/faq/LaTeX-Einfuehrung.html}\\
		Latex-Einführung\\
		28.September 2012
		\bibitem[Re:Web02]{JavaDoc:05}
