...
\begin{quote}
\textit{Textverarbeitung durch einen Rechner mit dem Ergebnis des Ausdrucks in Buchqualität ist durch die Entwicklung geeigneter Programme in den letzten Jahren möglich geworden.}\cite[Kopka, 2003, Seite 3]{kopka1:00}
\end{quote}
Bezug auf eine bestimmte Quelle in einem Buch:\\
Dieser Sachverhalt wird in \cite[Deming Klaus, 2002, Seite 17ff]{demig:04} genauer beschrieben.\\

Eine gute Einführung zu \LaTeX findet man unter \cite[LatexTutorial der Uni Hamburg]{Web:01}
